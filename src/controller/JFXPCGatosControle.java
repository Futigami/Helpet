...
public class JFXPCGatosControle {

	@FXML Button bPerfil;
	@FXML Button bMeuPet;
	@FXML Button bVoltar_PCGatos;
	
	private Stage palcoPCGato;
	
	
	public Stage getPalcoPCGato() {
		return palcoPCGato;
	}

	public void setPalcoPCGato(Stage palcoPCGato) {
		this.palcoPCGato = palcoPCGato;
	}
	...
	@FXML public void Perfil() throws IOException
	{
		...
		stage.initOwner(this.getPalcoPCGato());
